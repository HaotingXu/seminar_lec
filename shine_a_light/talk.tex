...
\begin{frame}\frametitle{\bch 如果不恰好相等\ech}
  ...
  通解为
  \be
  c_1(t) = e^{i\delta t/2}\left[A\cos\left(\frac{\sqrt{\Omega^2+\delta^2}}{2}\right)+B\sin\left(\frac{\sqrt{\Omega^2+\delta^2}}{2}\right)\right]
  \ee
...
\begin{frame}\frametitle{\bch 不恰好相等\ech}
  ...
  \left\{
  \begin{aligned}
    c_1(t) &=& e^{i\delta t/2}\left[\cos\left(\frac{\sqrt{\Omega^2+\delta^2}}{2}\right)-\frac{i\delta}{\sqrt{\Omega^2+\delta^2}}\sin\left(\frac{\sqrt{\Omega^2+\delta^2}}{2}\right)\right]\\
    c_2(t) &=& -ie^{i\delta t/2}\frac{\Omega}{\sqrt{\Omega^2+\delta^2}}\sin\left(\frac{\sqrt{\Omega^2+\delta^2}}{2}\right)
    \end{aligned}
  \right.
  \ee
